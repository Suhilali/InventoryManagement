		...
		foreach ($rows as $row) {
			?>
				<tr>
			        ...
			        <td>
						<a href="#" eid="<?php echo $row['cid']; ?>" data-toggle="modal" data-target="#Add_category" class="btn btn-info btn-sm edit_cat">Add</a>
...
// 	$obj = new DBOperation();
// 	$tot_rows = $obj->getAllUsers();
// 	foreach ($tot_rows as $row_) {
...
// 		"<td>".$row_["username"]."</td>".
//         "<td>".$row_["usertype"]."</td>".
// 		"<td>".$row_["register_date"]."</td>".
// 		"<td>".$row_["last_login"]."</td>".
//       "</tr>";
// 	}
// 	exit();
			...
			?>
				<tr>
			        ...
			        <td>
			        	...
			        	<a href="#" eid="<?php echo $row['id']; ?>" data-toggle="modal" data-target="#form_products" class="btn btn-info btn-sm edit_product">Edit</a>
			        </td>
			      </tr>
			<?php
			$n++;
		...
		foreach ($rows as $row) {
			?>
				<tr>
			        ...
			        <td><a href="#" class="btn btn-success btn-sm">Active</a></td>
			        <td>
						<a href="#" eid="<?php echo $row['pid']; ?>" data-toggle="modal" data-target="#form_products" class="btn btn-info btn-sm add_product">Add</a>
